...
\begin{definition}[\colordefinition{p-norm}]
...
\begin{definition}[\colordefinition{Lebesgue space}]
    We define
    \begin{align*}
...
\begin{definition}[\colordefinition{Banach space}]
...
\begin{definition}[\colordefinition{\(\boldsymbol{L^{\infty}}\)}]
