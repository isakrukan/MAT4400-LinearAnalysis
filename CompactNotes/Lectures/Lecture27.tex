...
\end{remark}
\begin{theorem}[\ifcolor\color{red}\textbf{Fourier Inversion Theorem}\color{black}\else Fourier Inversion Theorem \fi]
    ...
    \end{align*}
\end{theorem}
\begin{theorem}[\ifcolor\color{red}\textbf{convolution theorem}\color{black}\else convolution theorem \fi]
