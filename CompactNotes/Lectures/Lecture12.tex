...
\begin{definition}[\colordefinition{dense sets}]
...
\end{definition}
\begin{definition}[\colordefinition{support}]
...
\begin{theorem}
    ...
    compact \(K\subset K\). Then the space \important{\(C_c(X)\) of continuous compactly supported functions is dense in \(\mathcal{L}^p(X,d\mu)\)}.
\end{theorem}
...
\(C_c(\mathbb{R}^n)\) is dense in \(\mathcal{L}^p(\mathbb{R}^n, d\mu)\), \(1\leq p< \infty\). Later we will see that \important{even 
