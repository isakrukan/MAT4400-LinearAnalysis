...
$\A$-\colordefinition{measurable positive functions} and $\mathcal E(\A)$ $[\mathcal E^+_{\bar\R}(\A)]$ are the \colordefinition{positive and simple functions}.
...
\begin{theorem}[\ifcolor \color{red}\textbf{Beppo Levi}\color{black}\else Beppo Levi \fi]
    ...
    \end{align}
Note we can write \important{$\lim_{n\rightarrow \infty}$ instead of $\sup_{n\in\N}$} as the supremum of an increasing sequence
...
\begin{corollary}[\important{sum of positive functions}]
...
\begin{theorem}[\ifcolor \color{red}\textbf{Fatou}\color{black}\else Fatou \fi]
